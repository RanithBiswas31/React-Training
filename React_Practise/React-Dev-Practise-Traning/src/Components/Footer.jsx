const Footer = () => {
    return (
      <footer className="bg-gray-200 text-gray-800 p-6 mt-auto w-full">
        <nav className="flex justify-center gap-4 mb-4">
          <a href="#" className="hover:text-blue-500">About us</a>
          <a href="#" className="hover:text-blue-500">Contact</a>
          <a href="#" className="hover:text-blue-500">Jobs</a>
          <a href="#" className="hover:text-blue-500">Press kit</a>
        </nav>
        <nav className="flex justify-center gap-4 mb-4">
          <a href="#" className="flex items-center">
            <svg
              ...
              height="24"
              viewBox="0 0 24 24"
              className="fill-current text-gray-800 hover:text-blue-500"
            >
              <path
